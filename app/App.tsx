...
export default function App() {
    return (
        <NavigationContainer>
            <Stack.Navigator screenOptions={{ headerShown: false }} initialRouteName="MedicineDetail">
                ...
                <Stack.Screen name="MedicineDetail" component={MedicineDetail} options={{animation:"slide_from_left"}}/>
            </Stack.Navigator>
        </NavigationContainer>
		// <NewMedicine/>
		// <Main/>
